...
python emit_pkgdata() {
    ...
    if "virtual/kernel-image-initramfs" in provides or bb.data.inherits_class('kernel', d) or bb.data.inherits_class('module-base', d):
...
python package_do_filedeps() {
    ...
    for pkg in packages.split():
        ...
        for files in chunks(rpfiles, 200):
